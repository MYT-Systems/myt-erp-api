...
<body>
    <div style="width: 100%; height: 100%; background-color: #f5f5f5; padding: 20px; box-sizing: border-box;">
        <div style="text-align: end;">
            <span>SUPPLIES EXPENSE NO. <?= $supplies_expense['id'] ?></span>
        </div>
        ...
        <div style="margin-top: 20px; width: 100%; margin-bottom: 20px; background-color: #fff; padding: 20px; box-sizing: border-box;">
            ...
            <div>
                ...
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    ...
                    <div><?= $supplies_expense['branch_name'] ?></div>
                </div>
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    <div style="font-weight: bold;">Forwarder:</div>
                    <div><?= $supplies_expense['forwarder_name'] ?></div>
                </div>
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    <div style="font-weight: bold;">Delivery Address:</div>
                    <div><?= $supplies_expense['delivery_address'] ?></div>
                </div>
            </div>
            ...
            <div>
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    ...
                    <div><?= DATE('M d, Y', strtotime($supplies_expense['supplies_expense_date'])) ?></div>
                </div>
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    <div style="font-weight: bold;">Delivery Date:</div>
                    <div><?= DATE('M d, Y', strtotime($supplies_expense['delivery_date'])) ?></div>
                </div>
                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                    <div style="font-weight: bold;">Requisitioner:</div>
                    <div><?= $supplies_expense['requisitioner_name'] ?></div>
                </div>
            </div>

            <div style="margin-top: 20px; margin-bottom: 20px; background-color: #fff; padding: 20px; box-sizing: border-box;">
                <span> <?= $supplies_expense['remarks'] ?> </span>
            </div>
            <div style="margin-top: 20px; margin-bottom: 20px; background-color: #fff; padding: 20px; box-sizing: border-box;">
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #000;">
                    ...
                    <tbody>
                        <?php foreach ($supplies_expense_items as $item) : ?>
                        ...
                        <tr style="border-top: 1px solid #000;">
                            ...
                            <td style="border: 1px solid black;"><?= $supplies_expense['grand_total'] ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div style="margin:auto; width: 100%; display: flex; justify-content: space-between; margin-top: 10px; font-weight: bold;">
                <div style="text-align: center;">
                    ...
                    <p style="text-align: center; font-weight: bold; text-transform: uppercase"><?=  $supplies_expense['approved_by_name'] ?></p>
                    <p>Approved by</p>
                </div>
            </div>
        </div>
