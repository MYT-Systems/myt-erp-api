...
EOT;
    ...
    /**
     * Delete attachment by se_check_slip_id
     */
    public function delete_attachment_by_se_check_slip_id($se_check_slip_id = null, $requested_by = null, $db = null)
    {
        ...
        $sql = <<<EOT
UPDATE se_check_slip_attachment
