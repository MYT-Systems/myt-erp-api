...
class Supplies_expenses extends MYTController
{
    ...
    public function get_supplies_expense()
    {
        ...
        if (!$supplies_expense) {
            ...
            $supplies_expense[0]['se_items'] = $supplies_expense_attachment;
    ...
    public function get_all_supplies_expense()
    {
        ...
        if (!$supplies_expenses) {
            ...
            foreach ($supplies_expenses as $key => $supplies_expense) {
                $supplies_expense_attachment = $this->suppliesExpenseItemModel->get_details_by_supplies_expense_id($supplies_expense['id']);
                $supplies_expenses[$key]['se_items'] = $supplies_expense_attachment;
            }
    ...
    public function search()
    {
        ...
        if (!$supplies_expenses = $this->suppliesExpenseModel->search($supplier_id, $vendor_id, $forwarder_id, $supplies_expense_date, $delivery_date, $delivery_address, $remarks, $purpose, $requisitioner, $status, $order_status, $se_date_from, $se_date_to, $delivery_date_from, $delivery_date_to, $limit_by, $anything)) {
